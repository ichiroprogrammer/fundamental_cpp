...
&emsp;&emsp; [演算子オーバーロード](cpp03_syntax.md#SS_2_3)  
&emsp;&emsp;&emsp; [演算子オーバーロードの構文](cpp03_syntax.md#SS_2_3_1)  
&emsp;&emsp;&emsp; [演算子オーバーロードの指針](cpp03_syntax.md#SS_2_3_2)  

&emsp;&emsp; [デフォルト引数](cpp03_syntax.md#SS_2_4)  
&emsp;&emsp; [テンプレート](cpp03_syntax.md#SS_2_5)  
&emsp;&emsp;&emsp; [クラステンプレート](cpp03_syntax.md#SS_2_5_1)  
&emsp;&emsp;&emsp; [関数テンプレート](cpp03_syntax.md#SS_2_5_2)  

&emsp;&emsp; [名前空間](cpp03_syntax.md#SS_2_6)  
&emsp;&emsp; [標準ライブラリ](cpp03_syntax.md#SS_2_7)  
&emsp;&emsp;&emsp; [std::stringの使用例 ](cpp03_syntax.md#SS_2_7_1)  
&emsp;&emsp;&emsp; [入出力(stream)](cpp03_syntax.md#SS_2_7_2)  
&emsp;&emsp;&emsp; [コンテナ](cpp03_syntax.md#SS_2_7_3)  

&emsp;&emsp; [継承](cpp03_syntax.md#SS_2_8)  
&emsp;&emsp;&emsp; [public継承](cpp03_syntax.md#SS_2_8_1)  
&emsp;&emsp;&emsp; [protectd継承](cpp03_syntax.md#SS_2_8_2)  
&emsp;&emsp;&emsp; [private継承](cpp03_syntax.md#SS_2_8_3)  
&emsp;&emsp;&emsp; [派生](cpp03_syntax.md#SS_2_8_4)  
&emsp;&emsp;&emsp; [オーバーライド](cpp03_syntax.md#SS_2_8_5)  

&emsp;&emsp; [new/delete](cpp03_syntax.md#SS_2_9)  
&emsp;&emsp;&emsp; [new演算子](cpp03_syntax.md#SS_2_9_1)  
&emsp;&emsp;&emsp; [delete演算子](cpp03_syntax.md#SS_2_9_2)  
...
* [new/delete](cpp03_syntax.md#SS_2_9)
...
C++では、クラスに対して==に対する[演算子オーバーロード](cpp03_syntax.md#SS_2_3)を定義することで、そのクラス特有の等値性の定義を実装できる。
...
C++では演算子オーバーロードにより、ユーザー定義型を[組み込み型](core_lang_spec.md#SS_8_1_2)と同様の記法で扱えるようになる。
...
なお、例示したRationalのコンストラクタには[デフォルト引数](cpp03_syntax.md#SS_2_4)を用いて、利便性を向上させている。
...
が定義されている。下記に示したように、Rationalは通常の[整数型](core_lang_spec.md#SS_8_1_5)と同様に使用できる。
...
デフォルト引数は以下に示す通り、[リテラル](core_lang_spec.md#SS_8_2)である必要はない。
...
```cpp
    ...
    */
```
[演算子オーバーロードの指針](cpp03_syntax.md#SS_2_3_2)で使用したクラスRationalのコンストラクタは以下のようにデフォルト引数を用いることで、
自然な記述できるようにしている。
...
- [public継承](cpp03_syntax.md#SS_2_8_1)
- [protectd継承](cpp03_syntax.md#SS_2_8_2)
- [private継承](cpp03_syntax.md#SS_2_8_3)
...
* [new演算子](cpp03_syntax.md#SS_2_9_1)/[delete演算子](cpp03_syntax.md#SS_2_9_2)
