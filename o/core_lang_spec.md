...
* C++11の[moveセマンティクス](cpp_idioms.md#SS_21_5_3)と[perfect forwarding](core_lang_spec.md#SS_27_8_5)を実現するために導入された。
...
この動作を理解することは、
[moveセマンティクス](cpp_idioms.md#SS_21_5_3)や[perfect forwarding](core_lang_spec.md#SS_27_8_5)を正しく実装/使用するために極めて重要である。
