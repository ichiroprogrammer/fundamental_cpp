...
# 標準ライブラリとプログラミングの概念 <a id="SS_28"></a>
...
&emsp;&emsp; [ユーティリティ](stdlib_and_concepts.md#SS_28_1)  
&emsp;&emsp;&emsp; [std::move](stdlib_and_concepts.md#SS_28_1_1)  
&emsp;&emsp;&emsp; [std::forward](stdlib_and_concepts.md#SS_28_1_2)  

&emsp;&emsp; [type_traits](stdlib_and_concepts.md#SS_28_2)  
&emsp;&emsp;&emsp; [std::integral_constant](stdlib_and_concepts.md#SS_28_2_1)  
&emsp;&emsp;&emsp; [std::true_type](stdlib_and_concepts.md#SS_28_2_2)  
&emsp;&emsp;&emsp; [std::false_type](stdlib_and_concepts.md#SS_28_2_3)  
&emsp;&emsp;&emsp; [std::is_same](stdlib_and_concepts.md#SS_28_2_4)  
&emsp;&emsp;&emsp; [std::enable_if](stdlib_and_concepts.md#SS_28_2_5)  
&emsp;&emsp;&emsp; [std::conditional](stdlib_and_concepts.md#SS_28_2_6)  
&emsp;&emsp;&emsp; [std::is_void](stdlib_and_concepts.md#SS_28_2_7)  
&emsp;&emsp;&emsp; [std::is_copy_assignable](stdlib_and_concepts.md#SS_28_2_8)  
&emsp;&emsp;&emsp; [std::is_move_assignable](stdlib_and_concepts.md#SS_28_2_9)  

&emsp;&emsp; [並列処理](stdlib_and_concepts.md#SS_28_3)  
&emsp;&emsp;&emsp; [std::thread](stdlib_and_concepts.md#SS_28_3_1)  
&emsp;&emsp;&emsp; [std::mutex](stdlib_and_concepts.md#SS_28_3_2)  
&emsp;&emsp;&emsp; [std::atomic](stdlib_and_concepts.md#SS_28_3_3)  
&emsp;&emsp;&emsp; [std::condition_variable](stdlib_and_concepts.md#SS_28_3_4)  

&emsp;&emsp; [ロック所有ラッパー](stdlib_and_concepts.md#SS_28_4)  
&emsp;&emsp;&emsp; [std::lock_guard](stdlib_and_concepts.md#SS_28_4_1)  
&emsp;&emsp;&emsp; [std::unique_lock](stdlib_and_concepts.md#SS_28_4_2)  
&emsp;&emsp;&emsp; [std::scoped_lock](stdlib_and_concepts.md#SS_28_4_3)  

&emsp;&emsp; [スマートポインタ](stdlib_and_concepts.md#SS_28_5)  
&emsp;&emsp;&emsp; [std::unique_ptr](stdlib_and_concepts.md#SS_28_5_1)  
&emsp;&emsp;&emsp;&emsp; [std::make_unique](stdlib_and_concepts.md#SS_28_5_1_1)  

&emsp;&emsp;&emsp; [std::shared_ptr](stdlib_and_concepts.md#SS_28_5_2)  
&emsp;&emsp;&emsp;&emsp; [std::make_shared](stdlib_and_concepts.md#SS_28_5_2_1)  
&emsp;&emsp;&emsp;&emsp; [std::enable_shared_from_this](stdlib_and_concepts.md#SS_28_5_2_2)  

&emsp;&emsp;&emsp; [std::weak_ptr](stdlib_and_concepts.md#SS_28_5_3)  
&emsp;&emsp;&emsp; [std::auto_ptr](stdlib_and_concepts.md#SS_28_5_4)  

&emsp;&emsp; [Polymorphic Memory Resource(pmr)](stdlib_and_concepts.md#SS_28_6)  
&emsp;&emsp;&emsp; [std::pmr::memory_resource](stdlib_and_concepts.md#SS_28_6_1)  
&emsp;&emsp;&emsp; [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_28_6_2)  
&emsp;&emsp;&emsp; [pool_resource](stdlib_and_concepts.md#SS_28_6_3)  

&emsp;&emsp; [コンテナ](stdlib_and_concepts.md#SS_28_7)  
&emsp;&emsp;&emsp; [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_28_7_1)  
&emsp;&emsp;&emsp;&emsp; [std::forward_list](stdlib_and_concepts.md#SS_28_7_1_1)  

&emsp;&emsp;&emsp; [連想コンテナ(Associative Containers)](stdlib_and_concepts.md#SS_28_7_2)  
&emsp;&emsp;&emsp; [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_28_7_3)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_set](stdlib_and_concepts.md#SS_28_7_3_1)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_map](stdlib_and_concepts.md#SS_28_7_3_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_index](stdlib_and_concepts.md#SS_28_7_3_3)  

&emsp;&emsp;&emsp; [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_28_7_4)  
&emsp;&emsp;&emsp; [特殊なコンテナ](stdlib_and_concepts.md#SS_28_7_5)  

&emsp;&emsp; [std::optional](stdlib_and_concepts.md#SS_28_8)  
&emsp;&emsp;&emsp; [戻り値の無効表現](stdlib_and_concepts.md#SS_28_8_1)  
&emsp;&emsp;&emsp; [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_28_8_2)  

&emsp;&emsp; [std::variant](stdlib_and_concepts.md#SS_28_9)  
&emsp;&emsp; [オブジェクトの比較](stdlib_and_concepts.md#SS_28_10)  
&emsp;&emsp;&emsp; [std::rel_ops](stdlib_and_concepts.md#SS_28_10_1)  
&emsp;&emsp;&emsp; [std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_28_10_2)  

&emsp;&emsp; [その他](stdlib_and_concepts.md#SS_28_11)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](stdlib_and_concepts.md#SS_28_11_1)  
&emsp;&emsp;&emsp; [heap allocation elision](stdlib_and_concepts.md#SS_28_11_2)  
...
## ユーティリティ <a id="SS_28_1"></a>
### std::move <a id="SS_28_1_1"></a>
std::moveは引数を[rvalueリファレンス](core_lang_spec.md#SS_27_8_2)に変換する関数テンプレートである。

|引数                 |std::moveの動作                                    |
|---------------------|---------------------------------------------------|
|非const [lvalue](core_lang_spec.md#SS_27_7_1_1)|引数を[rvalueリファレンス](core_lang_spec.md#SS_27_8_2)にキャストする      |
|const [lvalue](core_lang_spec.md#SS_27_7_1_1)  |引数をconst [rvalueリファレンス](core_lang_spec.md#SS_27_8_2)にキャストする|
...
### std::forward <a id="SS_28_1_2"></a>
std::forwardは、下記の２つの概念を実現するための関数テンプレートである。

* [forwardingリファレンス](core_lang_spec.md#SS_27_8_3)
* [perfect forwarding](core_lang_spec.md#SS_27_8_5)

std::forwardを適切に使用することで、引数の値カテゴリを保持したまま転送でき、
move可能なオブジェクトの不要なコピーを避けることができる。

## type_traits <a id="SS_28_2"></a>
type_traitsは、型に関する情報をコンパイル時に取得・変換するためのメタ関数群で、
型特性の判定や型操作を静的に行うために用いられる。

以下に代表的なものをいくつか説明する。

- [std::integral_constant](stdlib_and_concepts.md#SS_28_2_1)
- [std::true_type](stdlib_and_concepts.md#SS_28_2_2)/[std::false_type](stdlib_and_concepts.md#SS_28_2_3)
- [std::is_same](stdlib_and_concepts.md#SS_28_2_4)
- [std::enable_if](stdlib_and_concepts.md#SS_28_2_5)
- [std::conditional](stdlib_and_concepts.md#SS_28_2_6)
- [std::is_void](stdlib_and_concepts.md#SS_28_2_7)
- [std::is_copy_assignable](stdlib_and_concepts.md#SS_28_2_8)
- [std::is_move_assignable](stdlib_and_concepts.md#SS_28_2_9)

### std::integral_constant <a id="SS_28_2_1"></a>
...
### std::true_type <a id="SS_28_2_2"></a>
`std::true_type`(と`std::false_type`)は真/偽を返す標準ライブラリの[メタ関数](core_lang_spec.md#SS_27_11_2)群の戻り型となる型エイリアスであるため、
最も使われるテンプレートの一つである。

これらは、下記で確かめられる通り、後述する[std::integral_constant](stdlib_and_concepts.md#SS_28_2_1)を使い定義されている。
...
### std::false_type <a id="SS_28_2_3"></a>
[std::true_type](stdlib_and_concepts.md#SS_28_2_2)を参照せよ。

### std::is_same <a id="SS_28_2_4"></a>
...
### std::enable_if <a id="SS_28_2_5"></a>
...
* std::enable_if\<true>::typeは[well-formed](core_lang_spec.md#SS_27_14_2)
* std::enable_if\<false>::typeは[ill-formed](core_lang_spec.md#SS_27_14_1)
...
std::enable_ifのこの特性と後述する[SFINAE](core_lang_spec.md#SS_27_11_1)により、
様々な静的ディスパッチを行うことができる。


### std::conditional <a id="SS_28_2_6"></a>
...
### std::is_copy_assignable <a id="SS_28_2_8"></a>
std::is_copy_assignableはテンプレートパラメータの型(T)がcopy代入可能かを調べる。
Tが[CopyAssignable要件](cpp_idioms.md#SS_29_5_5)を満たすためには`std::is_copy_assignable<T>`がtrueでなければならないが、
その逆が成立するとは限らない。


### std::is_move_assignable <a id="SS_28_2_9"></a>
std::is_move_assignableはテンプレートパラメータの型(T)がmove代入可能かを調べる。
Tが[MoveAssignable要件](cpp_idioms.md#SS_29_5_4)を満たすためには`std::is_move_assignable<T>`がtrueでなければならないが、
その逆が成立するとは限らない。


## 並列処理 <a id="SS_28_3"></a>

### std::thread <a id="SS_28_3_1"></a>
...
[クリティカルセクション](cpp_idioms.md#SS_29_12_4)と呼ぶ)が、std::mutexによりこの問題を回避している。
...
mutexは通常、[std::lock_guard](stdlib_and_concepts.md#SS_28_4_1)と組み合わせて使われる。

### std::atomic <a id="SS_28_3_3"></a>
atomicクラステンプレートは、型Tをアトミック操作するためのものである。
[組み込み型](core_lang_spec.md#SS_27_1_2)に対する特殊化が提供されており、それぞれに特化した演算が用意されている。
[std::mutex](stdlib_and_concepts.md#SS_28_3_2)で示したような単純なコードではstd::atomicを使用して下記のように書く方が一般的である。
...
### std::condition_variable <a id="SS_28_3_4"></a>
condition_variable は、特定のイベントが発生するまでスレッドの待ち合わせを行うためのクラスである。
最も単純な使用例を以下に示す(「[Spurious Wakeup](cpp_idioms.md#SS_29_12_11)」参照)。
```cpp
...
## ロック所有ラッパー <a id="SS_28_4"></a>
ロック所有ラッパーとはミューテックスのロックおよびアンロックを管理するための以下のクラスを指す。

- [std::lock_guard](stdlib_and_concepts.md#SS_28_4_1)
- [std::unique_lock](stdlib_and_concepts.md#SS_28_4_2)
- [std::scoped_lock](stdlib_and_concepts.md#SS_28_4_3)


### std::lock_guard <a id="SS_28_4_1"></a>
...
### std::unique_lock <a id="SS_28_4_2"></a>
...
下記のコード例では、[std::lock_guard](stdlib_and_concepts.md#SS_28_4_1)の説明で述べたようにmutex::lock()、mutex::unlock()を直接呼び出すのではなく、
...
一般に条件変数には、[Spurious Wakeup](cpp_idioms.md#SS_29_12_11)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](cpp_idioms.md#SS_29_12_11)の対策が行われていないため、
意図通り動作しない可能性がある。
...
### std::scoped_lock <a id="SS_28_4_3"></a>
...
* [std::unique_ptr](stdlib_and_concepts.md#SS_28_5_1)
    - [std::make_unique](stdlib_and_concepts.md#SS_28_5_1_1)
* [std::shared_ptr](stdlib_and_concepts.md#SS_28_5_2)
    - [std::make_shared](stdlib_and_concepts.md#SS_28_5_2_1)
    - [std::enable_shared_from_this](stdlib_and_concepts.md#SS_28_5_2_2)
    - [std::weak_ptr](stdlib_and_concepts.md#SS_28_5_3)
* [std::auto_ptr](stdlib_and_concepts.md#SS_28_5_4)

### std::unique_ptr <a id="SS_28_5_1"></a>
std::unique_ptrは、C++11で導入されたスマートポインタの一種であり、std::shared_ptrとは異なり、
[オブジェクトの排他所有](cpp_idioms.md#SS_29_4_1)を表すために用いられる。所有権は一つのunique_ptrインスタンスに限定され、
他のポインタと共有することはできない。ムーブ操作によってのみ所有権を移譲でき、
スコープを抜けると自動的にリソースが解放されるため、メモリ管理の安全性と効率性が向上する。

#### std::make_unique <a id="SS_28_5_1_1"></a>
...
使用例については、「[オブジェクトの排他所有](cpp_idioms.md#SS_29_4_1)」を参照せよ。

### std::shared_ptr <a id="SS_28_5_2"></a>
std::shared_ptrは、同じくC++11で導入されたスマートポインタであり、[オブジェクトの共有所有](cpp_idioms.md#SS_29_4_2)を表すために用いられる。
複数のshared_ptrインスタンスが同じリソースを参照でき、
内部の参照カウントによって最後の所有者が破棄された時点でリソースが解放される。
[std::weak_ptr](stdlib_and_concepts.md#SS_28_5_3)は、shared_ptrと連携して使用されるスマートポインタであり、オブジェクトの非所有参照を表す。
参照カウントには影響せず、循環参照を防ぐために用いられる。weak_ptrから一時的にshared_ptrを取得するにはlock()を使用する。

#### std::make_shared <a id="SS_28_5_2_1"></a>
[std::make_shared\<T\>(Args...)](https://cpprefjp.github.io/reference/memory/make_shared.html)は、
クラスTをダイナミックに生成し、そのポインタを保持するshared_ptrオブジェクトを生成する。

使用例については、「[オブジェクトの共有所有](cpp_idioms.md#SS_29_4_2)」を参照せよ。

#### std::enable_shared_from_this <a id="SS_28_5_2_2"></a>
...
weak_ptrを返すため[オブジェクトの循環所有](cpp_idioms.md#SS_29_4_3)を避けたい場合に有用である。

### std::weak_ptr <a id="SS_28_5_3"></a>
std::weak_ptrは、スマートポインタの一種である。

std::weak_ptrは参照カウントに影響を与えず、[std::shared_ptr](stdlib_and_concepts.md#SS_28_5_2)とオブジェクトを共有所有するのではなく、
その`shared_ptr`インスタンスとの関連のみを保持するのため、[オブジェクトの循環所有](cpp_idioms.md#SS_29_4_3)の問題を解決できる。

[オブジェクトの循環所有](cpp_idioms.md#SS_29_4_3)で示した問題のあるクラスの修正版を以下に示す
...
なお、上記コードは[初期化付きif文](core_lang_spec.md#SS_27_9_5_3)を使うことで、
...
### std::auto_ptr <a id="SS_28_5_4"></a>
`std::auto_ptr`はC++11以前に導入された初期のスマートポインタであるが、異常な[copyセマンティクス](cpp_idioms.md#SS_29_5_2)を持つため、
多くの誤用を生み出し、C++11から非推奨とされ、C++17から規格から排除された。


## Polymorphic Memory Resource(pmr) <a id="SS_28_6"></a>
Polymorphic Memory Resource(pmr)は、
動的メモリ管理の柔軟性と効率性を向上させるための、C++17から導入された仕組みである。

[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_28_6_2)はC++17で導入された標準ライブラリのクラスで、
...
* [std::pmr::memory_resource](stdlib_and_concepts.md#SS_28_6_1)  
* [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_28_6_2)  
* [pool_resource](stdlib_and_concepts.md#SS_28_6_3)

### std::pmr::memory_resource <a id="SS_28_6_1"></a>
std::pmr::memory_resourceは、
ユーザー定義のメモリリソースをカスタマイズし、
[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_28_6_2)を通じて利用可能にする[インターフェースクラス](core_lang_spec.md#SS_27_4_11)である。
...
### std::pmr::polymorphic_allocator <a id="SS_28_6_2"></a>
std::pmr::polymorphic_allocatorはC++17で導入された標準ライブラリのクラスで、
C++のメモリリソース管理を抽象化するための機能を提供する。
[std::pmr::memory_resource](stdlib_and_concepts.md#SS_28_6_1)を基盤とし、
コンテナやアルゴリズムにカスタムメモリアロケーション戦略を容易に適用可能にする。
std::allocatorと異なり、型に依存せず、
ポリモーフィズムを活用してメモリリソースを切り替えられる点が特徴である。

すでに示したmemory_resource_variable([std::pmr::memory_resource](stdlib_and_concepts.md#SS_28_6_1))の単体テストを以下に示すことにより、
...
### pool_resource <a id="SS_28_6_3"></a>
pool_resourceは[std::pmr::memory_resource](stdlib_and_concepts.md#SS_28_6_1)を基底とする下記の2つの具象クラスである。
...
* [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_28_7_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_28_7_3)
* [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_28_7_4)
* [特殊なコンテナ](stdlib_and_concepts.md#SS_28_7_5)

### シーケンスコンテナ(Sequence Containers) <a id="SS_28_7_1"></a>
...
| [std::forward_list](stdlib_and_concepts.md#SS_28_7_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
| `std::array`             | 固定長配列で、サイズがコンパイル時に決まる                          |
| `std::string`            | 可変長の文字列を管理するクラス(厳密には`std::basic_string`の特殊化) |

#### std::forward_list <a id="SS_28_7_1_1"></a>
...
### 連想コンテナ(Associative Containers) <a id="SS_28_7_2"></a>
...
### 無順序連想コンテナ(Unordered Associative Containers) <a id="SS_28_7_3"></a>
ハッシュテーブルを基盤としたコンテナで、順序を保証しないが高速な検索を提供する。

| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](stdlib_and_concepts.md#SS_28_7_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](stdlib_and_concepts.md#SS_28_7_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
| `std::unordered_multimap` | ハッシュテーブルベースのキーと値のペア。キーは重複可能 |
| [std::type_index](stdlib_and_concepts.md#SS_28_7_3_3)    | 型情報型を連想コンテナのキーとして使用するためのクラス |

#### std::unordered_set <a id="SS_28_7_3_1"></a>
...
#### std::unordered_map <a id="SS_28_7_3_2"></a>
...
#### std::type_index <a id="SS_28_7_3_3"></a>
...
### コンテナアダプタ(Container Adapters) <a id="SS_28_7_4"></a>
...
1. 関数の任意の型の[戻り値の無効表現](stdlib_and_concepts.md#SS_28_8_1)を持たせる
2. [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_28_8_2)する(初期化処理が重く、
   条件によってはそれが無駄になる場合にこの機能を使う)

### 戻り値の無効表現 <a id="SS_28_8_1"></a>
```cpp
...
std::variantとstd::visit([Visitor](temp.md#SS_4_1)パターンの実装の一種)を組み合わせた場合の使用例を以下に示す。
...
## オブジェクトの比較 <a id="SS_28_10"></a>
### std::rel_ops <a id="SS_28_10_1"></a>
...
なお、std::rel_opsはC++20から導入された[<=>演算子](core_lang_spec.md#SS_27_6_4_1)により不要になったため、
非推奨とされた。

### std::tuppleを使用した比較演算子の実装方法 <a id="SS_28_10_2"></a>
クラスのメンバが多い場合、[==演算子](core_lang_spec.md#SS_27_6_3)で示したような方法は、
...
## その他 <a id="SS_28_11"></a>
### SSO(Small String Optimization) <a id="SS_28_11_1"></a>
...
### heap allocation elision <a id="SS_28_11_2"></a>
