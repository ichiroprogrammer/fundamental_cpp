...
C++では、クラスに対して==に対する[演算子オーバーロード](---)を定義することで、そのクラス特有の等値性の定義を実装できる。
...
```cpp
    // @@@ example/cpp03_syntax/overload_ut.cpp #0:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/overload_ut.cpp #0:1 begin -1
```
...
```cpp
    // @@@ example/cpp03_syntax/overload_ut.cpp #1:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/overload_ut.cpp #1:1 begin -1
```
...
```cpp
    // @@@ example/cpp03_syntax/overload_ut.cpp #2:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/overload_ut.cpp #2:1 begin -1
```
...
```cpp
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #0:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #0:1 begin -1
```

C++では演算子オーバーロードにより、ユーザー定義型を[組み込み型](---)と同様の記法で扱えるようになる。

```cpp
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #1:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #1:1 begin -1
```
...
なお、例示したRationalのコンストラクタには[デフォルト引数](---)を用いて、利便性を向上させている。

```cpp
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #2:0 begin
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #2:1 begin
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #2:2 begin
```
...
が定義されている。下記に示したように、Rationalは通常の[整数型](---)と同様に使用できる。

```cpp
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #2:3 begin -1
    // @@@ example/cpp03_syntax/operator_overload_ut.cpp #2:4 begin -1
```
...
```cpp
    // @@@ example/cpp03_syntax/defaut_arg_ut.cpp #0:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/defaut_arg_ut.cpp #0:1 begin -1
```

デフォルト引数は以下に示す通り、[リテラル](---)である必要はない。

```cpp
    // @@@ example/cpp03_syntax/defaut_arg_ut.cpp #1:0 begin
```
```cpp
    // @@@ example/cpp03_syntax/defaut_arg_ut.cpp #1:1 begin -1
```
...
```cpp
    // @@@ example/cpp03_syntax/defaut_arg_ut.cpp #2:0 begin
```
[演算子オーバーロードの指針](---)で使用したクラスRationalのコンストラクタは以下のようにデフォルト引数を用いることで、
自然な記述できるようにしている。
