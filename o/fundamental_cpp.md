...
&emsp;&emsp;&emsp; [ムーブコンストラクタ/ムーブ代入演算子](#SS_2_1_8)  
...
### メンバ変数の初期化 <a id="SS_2_1_9"></a>

### this <a id="SS_2_1_10"></a>
...
&emsp;&emsp;&emsp; [lvalue](#SS_3_14_2)  
&emsp;&emsp;&emsp; [rvalue](#SS_3_14_3)  
&emsp;&emsp;&emsp;&emsp; [xvalue](#SS_3_14_3_1)  
&emsp;&emsp;&emsp;&emsp; [prvalue](#SS_3_14_3_2)  

&emsp;&emsp;&emsp; [rvalue修飾](#SS_3_14_4)  
&emsp;&emsp;&emsp; [lvalue修飾](#SS_3_14_5)  
&emsp;&emsp;&emsp; [リファレンス修飾](#SS_3_14_6)  

&emsp;&emsp; [リファレンス](#SS_3_15)  
&emsp;&emsp;&emsp; [ユニバーサルリファレンス](#SS_3_15_1)  
&emsp;&emsp;&emsp; [forwardingリファレンス](#SS_3_15_2)  
&emsp;&emsp;&emsp; [perfect forwarding](#SS_3_15_3)  
&emsp;&emsp;&emsp; [リファレンスcollapsing](#SS_3_15_4)  
&emsp;&emsp;&emsp; [danglingリファレンス](#SS_3_15_5)  
&emsp;&emsp;&emsp; [danglingポインタ](#SS_3_15_6)  

&emsp;&emsp; [エクセプション安全性の保証](#SS_3_16)  
&emsp;&emsp;&emsp; [no-fail保証](#SS_3_16_1)  
&emsp;&emsp;&emsp; [強い安全性の保証](#SS_3_16_2)  
&emsp;&emsp;&emsp; [基本的な安全性の保証](#SS_3_16_3)  
&emsp;&emsp;&emsp; [noexcept](#SS_3_16_4)  
&emsp;&emsp;&emsp; [exception-unfriendly](#SS_3_16_5)  

&emsp;&emsp; [シンタックス、セマンティクス](#SS_3_17)  
&emsp;&emsp;&emsp; [等価性のセマンティクス](#SS_3_17_1)  
&emsp;&emsp;&emsp; [copyセマンティクス](#SS_3_17_2)  
&emsp;&emsp;&emsp; [moveセマンティクス](#SS_3_17_3)  
&emsp;&emsp;&emsp; [MoveAssignable要件](#SS_3_17_4)  
&emsp;&emsp;&emsp; [CopyAssignable要件](#SS_3_17_5)  

&emsp;&emsp; [C++その他](#SS_3_18)  
&emsp;&emsp;&emsp; [型特性キーワード](#SS_3_18_1)  
&emsp;&emsp;&emsp;&emsp; [alignof](#SS_3_18_1_1)  
&emsp;&emsp;&emsp;&emsp; [alignas](#SS_3_18_1_2)  
&emsp;&emsp;&emsp;&emsp; [addressof](#SS_3_18_1_3)  

&emsp;&emsp;&emsp; [演算子のオペランドの評価順位](#SS_3_18_2)  
&emsp;&emsp;&emsp; [実引数/仮引数](#SS_3_18_3)  
&emsp;&emsp;&emsp; [単純代入](#SS_3_18_4)  
&emsp;&emsp;&emsp; [ill-formed](#SS_3_18_5)  
&emsp;&emsp;&emsp; [well-formed](#SS_3_18_6)  
&emsp;&emsp;&emsp; [未定義動作](#SS_3_18_7)  
&emsp;&emsp;&emsp; [未規定動作](#SS_3_18_8)  
&emsp;&emsp;&emsp; [未定義動作と未規定動作](#SS_3_18_9)  
&emsp;&emsp;&emsp; [被修飾型](#SS_3_18_10)  
&emsp;&emsp;&emsp; [one-definition rule](#SS_3_18_11)  
&emsp;&emsp;&emsp; [ODR](#SS_3_18_12)  
&emsp;&emsp;&emsp; [RVO(Return Value Optimization)](#SS_3_18_13)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](#SS_3_18_14)  
&emsp;&emsp;&emsp; [heap allocation elision](#SS_3_18_15)  
&emsp;&emsp;&emsp; [Most Vexing Parse](#SS_3_18_16)  
&emsp;&emsp;&emsp; [トライグラフ](#SS_3_18_17)  

&emsp;&emsp; [C++コンパイラ](#SS_3_19)  
&emsp;&emsp;&emsp; [g++](#SS_3_19_1)  
&emsp;&emsp;&emsp; [clang++](#SS_3_19_2)  

&emsp;&emsp; [ソフトウェア一般](#SS_3_20)  
&emsp;&emsp;&emsp; [フリースタンディング環境](#SS_3_20_1)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](#SS_3_20_2)  
&emsp;&emsp;&emsp; [凝集度](#SS_3_20_3)  
&emsp;&emsp;&emsp;&emsp; [凝集度の欠如](#SS_3_20_3_1)  
&emsp;&emsp;&emsp;&emsp; [LCOMの評価基準](#SS_3_20_3_2)  

&emsp;&emsp;&emsp; [Spurious Wakeup](#SS_3_20_4)  
&emsp;&emsp;&emsp; [副作用](#SS_3_20_5)  
&emsp;&emsp;&emsp; [is-a](#SS_3_20_6)  
&emsp;&emsp;&emsp; [has-a](#SS_3_20_7)  
&emsp;&emsp;&emsp; [is-implemented-in-terms-of](#SS_3_20_8)  
&emsp;&emsp;&emsp;&emsp; [public継承によるis-implemented-in-terms-of](#SS_3_20_8_1)  
&emsp;&emsp;&emsp;&emsp; [private継承によるis-implemented-in-terms-of](#SS_3_20_8_2)  
&emsp;&emsp;&emsp;&emsp; [コンポジションによる(has-a)is-implemented-in-terms-of](#SS_3_20_8_3)  

&emsp;&emsp; [非ソフトウェア用語](#SS_3_21)  
&emsp;&emsp;&emsp; [割れ窓理論](#SS_3_21_1)  
&emsp;&emsp;&emsp; [車輪の再発明](#SS_3_21_2)  
...
* [等価性のセマンティクス](#SS_3_17_1)
* [copyセマンティクス](#SS_3_17_2)
* [moveセマンティクス](#SS_3_17_3)
...
各クラスがvtblへのポインタを保持するため、このドキュメントで使用している[g++](#SS_3_19_1)では、
...
このドキュメントのコードのコンパイルに使用している[g++](#SS_3_19_1)/[clang++](#SS_3_19_2)では、
そのような関数は、`abi::__cxa_demangle`である。

`std::type_info::name()`と`abi::__cxa_demangle`を利用して、
オブジェクトの[被修飾型](#SS_3_18_10)名をstd::stringオブジェクトとして取り出す関数とその使用例を以下に示す。
...
[ill-formed](#SS_3_18_5)を使用した場合分けが可能になる。
...
オブジェクトの所有権やその移動、
std::unique_ptr、std::move()、[rvalue](#SS_3_14_3)の関係を解説する。
...
下記に示した上記クラスの単体テストにより、
オブジェクトの所有権やその移動、共有、
std::shared_ptr、std::move()、[rvalue](#SS_3_14_3)の関係を解説する。
...
* prvalue(「[rvalue](#SS_3_14_3)」参照)のライフタイム
...
このような状態のリファレンスを[danglingリファレンス](#SS_3_15_5)と呼ぶ。
同様に、このような状態のポインタを[danglingポインタ](#SS_3_15_6)と呼ぶ。
...
スライシングが起こった場合、そうならないことが問題である(「[等価性のセマンティクス](#SS_3_17_1)」参照)。
...
* `std::auto_ptr`はC++11以前に導入された初期のスマートポインタであるが、
   異常な[copyセマンティクス](#SS_3_17_2)を持つため、多くの誤用を生み出し、
...
サンプルコードを[g++](#SS_3_19_1)と[clang++](#SS_3_19_2)でコンパイルしている)。
...
によるとこの動作は未定義のようだが、
[g++](#SS_3_19_1)/[clang++](#SS_3_19_2)両方ともこのコードを警告なしでコンパイルする)。
...
このテストはエラーとならなければならないが、[g++](#SS_3_19_1)ではパスしてしまう。
2nd name lookupのロジックにバグがあるようである。

有難いことに、[clang++](#SS_3_19_2)では仕様通りこのテストはエラーとなり、
...
「テンプレートのパラメータ置き換えに失敗した([ill-formed](#SS_3_18_5)になった)際に、
...
といったセマンティクス的観点(「[シンタックス、セマンティクス](#SS_3_17)」参照)によるものである。
...
### lvalue <a id="SS_3_14_2"></a>
「[expression](#SS_3_14_1)」を参照せよ。

### rvalue <a id="SS_3_14_3"></a>
「[expression](#SS_3_14_1)」を参照せよ。

#### xvalue <a id="SS_3_14_3_1"></a>
「[expression](#SS_3_14_1)」を参照せよ。

#### prvalue <a id="SS_3_14_3_2"></a>
「[expression](#SS_3_14_1)」を参照せよ。

### rvalue修飾 <a id="SS_3_14_4"></a>
...
### lvalue修飾 <a id="SS_3_14_5"></a>
[rvalue修飾](#SS_3_14_4)を参照せよ。


### リファレンス修飾 <a id="SS_3_14_6"></a>
[rvalue修飾](#SS_3_14_4)と[lvalue修飾](#SS_3_14_5)とを併せて、リファレンス修飾と呼ぶ。


## リファレンス <a id="SS_3_15"></a>
ここでは、C++11から導入された

* [ユニバーサルリファレンス](#SS_3_15_1)
* [リファレンスcollapsing](#SS_3_15_4)

について解説する。

### ユニバーサルリファレンス <a id="SS_3_15_1"></a>
...
下記のコードは[ジェネリックラムダ](#SS_3_11_4)の引数をユニバーサルリファレンスにした例である。
...
### forwardingリファレンス <a id="SS_3_15_2"></a>
「[ユニバーサルリファレンス](#SS_3_15_1)」を参照せよ。

### perfect forwarding <a id="SS_3_15_3"></a>
perfect forwarding とは、引数の[rvalue](#SS_3_14_3)性や
[lvalue](#SS_3_14_2)性を損失することなく、
その引数を別の関数に転送する技術のことを指す。
通常は、[ユニバーサルリファレンス](#SS_3_15_1)である関数の仮引数をstd::forwardを用いて、
他の関数に渡すことで実現される。

### リファレンスcollapsing <a id="SS_3_15_4"></a>
...
### danglingリファレンス <a id="SS_3_15_5"></a>
Dangling リファレンスとは、破棄後のオブジェクトを指しているリファレンスを指す。
このようなリファレンスにアクセスすると、[未定義動作](#SS_3_18_7)に繋がるに繋がる。
...
### danglingポインタ <a id="SS_3_15_6"></a>
danglingポインタとは、[danglingリファレンス](#SS_3_15_5)と同じような状態になったポインタを指す。

## エクセプション安全性の保証 <a id="SS_3_16"></a>
関数のエクセプション発生時の安全性の保証には以下の3つのレベルが規定されている。

* [no-fail保証](#SS_3_16_1)
* [強い安全性の保証](#SS_3_16_2)
* [基本的な安全性の保証](#SS_3_16_3)

### no-fail保証 <a id="SS_3_16_1"></a>
「no-fail保証」を満たす関数はエクセプションをthrowしない。
no-failを保証する関数は、
[noexcept](#SS_3_16_4)を使用してエクセプションを発生させないことを明示できる。

標準テンプレートクラスのパラメータとして使用するクラスのメンバ関数には、
正確にnoexceptの宣言をしないと、
テンプレートクラスのメンバ関数によってはパフォーマンスを起こしてしまう可能性がある。

### 強い安全性の保証 <a id="SS_3_16_2"></a>
...
### exception-unfriendly <a id="SS_3_16_5"></a>
以下のような関数  
...
の呼び出しでエクセプションがthrowされると、[未定義動作](#SS_3_18_7)や[未規定動作](#SS_3_18_8)が発生するため、
exception-unfriendly(エクセプションに不向き)であるとされる。
従って上記の関数は暗黙的または明示的に`noexcept`であることが求められる。

## シンタックス、セマンティクス <a id="SS_3_17"></a>
...
* 「[等価性のセマンティクス](#SS_3_17_1)」を守ってる
* 「[copyセマンティクス](#SS_3_17_2)」を守ってる
* 「[moveセマンティクス](#SS_3_17_3)」を守っている

等がセマンティクス的な正しさである。

セマンティクス的に正しいソースコードは読みやすく、保守性、拡張性に優れている。

### 等価性のセマンティクス <a id="SS_3_17_1"></a>
...
下記の単体テストから明らかな通り、
「[等価性のセマンティクス](#SS_3_17_1)」で示した最後の例も、copyセマンティクスを満たしていない。
...
* a == bがtrueの時に、c = std::move(a)が行われた場合、
  ...
  そのリソースはcに移動している」ことが一般的である(「[rvalue](#SS_3_14_3)」参照)。

* [no-fail保証](#SS_3_16_1)をする(noexceptと宣言し、エクセプションをthrowしない)。
...
### MoveAssignable要件 <a id="SS_3_17_4"></a>
...
4. 効率性  
   ...
   これは、リソースの複製を避けることで達成される(「[moveセマンティクス](#SS_3_17_3)」参照)。
...
### CopyAssignable要件 <a id="SS_3_17_5"></a>
...
3. 正しいセマンティクス  
   コピー代入によって代入元のオブジェクトが変更されてはならない(「[copyセマンティクス](#SS_3_17_2)」参照)。
...
## C++その他 <a id="SS_3_18"></a>
### 型特性キーワード <a id="SS_3_18_1"></a>
アライメントとは、
データが効率的にアクセスされるために特定のメモリアドレス境界に配置される規則である。
C++03までの規約では、アライメントのコントロールは実装依存した#pragmaなどで行っていた。

[alignas](#SS_3_18_1_2)、
[alignof](#SS_3_18_1_1)によりコンパイラの標準的な方法でアライメントのコントロールできるようになった。

#### alignof <a id="SS_3_18_1_1"></a>
...
### 演算子のオペランドの評価順位 <a id="SS_3_18_2"></a>

C++17で、演算子のオペランドに対する評価順序が明確に規定された。
それに対し、C++14までは、演算子のオペランド部分式の評価順序は[未規定動作](#SS_3_18_8)であった。
...
### 単純代入 <a id="SS_3_18_4"></a>
代入は下記のように分類される。

* 単純代入(=)
* 複合代入(+=，++ 等)

### ill-formed <a id="SS_3_18_5"></a>
[標準規格と処理系](https://cpprefjp.github.io/implementation-compliance.html)に詳しい解説があるが、

* [well-formed](#SS_3_18_6)(適格)とはプログラムが全ての構文規則・診断対象の意味規則・
  単一定義規則を満たすことである。
...
### well-formed <a id="SS_3_18_6"></a>
「[ill-formed](#SS_3_18_5)」を参照せよ。

### 未定義動作 <a id="SS_3_18_7"></a>
...
### 未定義動作と未規定動作 <a id="SS_3_18_9"></a>
| 種類            |定義                                                               | 例                               | 結果                           |
|-----------------|-------------------------------------------------------------------|----------------------------------|--------------------------------|
|[未定義動作](#SS_3_18_7)|C++標準が全く保証しない動作                                        | ゼロ除算、配列範囲外アクセス     | 予測不能(クラッシュなど)       |
|[未規定動作](#SS_3_18_8)|C++標準が動作を定めていないが、いくつかの選択肢が許容されている動作| `int8_t` に収まらない値のキャスト| 実装依存(異なるが合理的な動作) |


### 被修飾型 <a id="SS_3_18_10"></a>
...
### one-definition rule <a id="SS_3_18_11"></a>
「[ODR](#SS_3_18_12)」を参照せよ。

### ODR <a id="SS_3_18_12"></a>
...
### RVO(Return Value Optimization) <a id="SS_3_18_13"></a>
関数の戻り値がオブジェクトである場合、
...
### SSO(Small String Optimization) <a id="SS_3_18_14"></a>
...
### heap allocation elision <a id="SS_3_18_15"></a>
...
### Most Vexing Parse <a id="SS_3_18_16"></a>
...
## ソフトウェア一般 <a id="SS_3_20"></a>
### フリースタンディング環境 <a id="SS_3_20_1"></a>
...
### 凝集度 <a id="SS_3_20_3"></a>
[凝集度](https://ja.wikipedia.org/wiki/%E5%87%9D%E9%9B%86%E5%BA%A6)
とはクラス設計の妥当性を表す尺度の一種であり、
「[凝集度の欠如](#SS_3_20_3_1)(LCOM)」というメトリクスで計測される。

* [凝集度の欠如](#SS_3_20_3_1)メトリクスの値が1に近ければ凝集度は低く、この値が0に近ければ凝集度は高い。
...
#### 凝集度の欠如 <a id="SS_3_20_3_1"></a>
[凝集度](#SS_3_20_3)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
[LCOMの評価基準](#SS_3_20_3_2)に具体的な推奨値を示す。

#### LCOMの評価基準 <a id="SS_3_20_3_2"></a>
...
### Spurious Wakeup <a id="SS_3_20_4"></a>
...
kyukanchoとstd::stringの関係を[has-a](#SS_3_20_7)の関係と呼ぶ。


### has-a <a id="SS_3_20_7"></a>
「has-a」の関係は、
...
### is-implemented-in-terms-of <a id="SS_3_20_8"></a>
...
自身の機能を提供する場合に使われる。
[has-a](#SS_3_20_7)の関係は、is-implemented-in-terms-of の関係の一種である。

is-implemented-in-terms-ofは下記の手段1-3に示した方法がある。

*手段1.* [public継承によるis-implemented-in-terms-of](#SS_3_20_8_1)  
*手段2.* [private継承によるis-implemented-in-terms-of](#SS_3_20_8_2)  
*手段3.* [コンポジションによる(has-a)is-implemented-in-terms-of](#SS_3_20_8_3)  
...
手段1は[is-a](#SS_3_20_6)に見え、以下に示すような問題も考慮する必要があるため、
可読性、保守性を劣化させる可能性がある。
...
#### public継承によるis-implemented-in-terms-of <a id="SS_3_20_8_1"></a>
...
すでに述べたようにこの方法は、
[private継承によるis-implemented-in-terms-of](#SS_3_20_8_2)や、
[コンポジションによる(has-a)is-implemented-in-terms-of](#SS_3_20_8_3)
と比べコードがシンプルになる。 

#### private継承によるis-implemented-in-terms-of <a id="SS_3_20_8_2"></a>
...
この方法は、[public継承によるis-implemented-in-terms-of](#SS_3_20_8_1)が持つデストラクタ問題は発生せす、
[is-a](#SS_3_20_6)と誤解してしまう問題も発生しない。


#### コンポジションによる(has-a)is-implemented-in-terms-of <a id="SS_3_20_8_3"></a>
...
## 非ソフトウェア用語 <a id="SS_3_21"></a>
### 割れ窓理論 <a id="SS_3_21_1"></a>
...
|[rvalue](#SS_3_14_3)/[moveセマンティクス](#SS_3_17_3)|[オブジェクトの所有権](#SS_3_5_7)の移転、高速化。              |
|[ラムダ式](#SS_3_8_3)                                      |関数オブジェクトをその場に書く                                              |
|[noexcept](#SS_3_16_4)                                               |関数の例外指定、例外を投げる可能性のある式かbool値を返す演算子              |
...
|メンバ関数の[rvalue修飾](#SS_3_14_4)/[lvalue修飾](#SS_3_14_5)              |オブジェクトの[expressionと値カテゴリ](#SS_3_14)での呼び出し可能であることの指定|
...
|任意の式による[SFINAE](#SS_3_11_1)         |特定の式が[ill-formed](#SS_3_18_5)か否かで、その関数をオーバーロード解決に含めるかどうかを決定する|
|テンプレートのエクスポート機能      |削除                                                                                       |
...
[コンテナ](#SS_3_9_2)全般が[moveセマンティクス](#SS_3_17_3)に対応したため、
...
|[heap allocation elision](#SS_3_18_15)                      |動的メモリ確保の省略(heap allocation elision)の許可                              |
...
|[RVO(Return Value Optimization)](#SS_3_18_13)        |右辺値を変数の初期化のために使用する場合、コピーもムーブも省略することを保証                       |
|[演算子のオペランドの評価順位](#SS_3_18_2)          |C++14まで未規定であった部分式の評価順序を規定                                                      |
...
|const修飾されたメンバポインタの制限を修正      |`.*`演算子での[lvalue](#SS_3_14_2)のconstメンバ関数呼び出しを許可                                          |
