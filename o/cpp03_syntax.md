...
&emsp;&emsp;&emsp; [コンテナ](cpp03_syntax.md#SS_2_2_2)  
...
public継承では、
以下のコードのように派生クラスのオブジェクトを基底クラスのポインタや[リファレンス](core_lang_spec.md#SS_19_8)として扱うことができる。
これによりポリモーフィズムが実現される。
...
派生クラスを設計する際は、「[is-a](cpp_idioms.md#SS_21_3_1)」関係が成立するかを確認する必要がある。
